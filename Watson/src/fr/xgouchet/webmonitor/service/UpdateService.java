...
public class UpdateService extends IntentService {
    ...
    private void fetchTargets() {
        ...
        Cursor cursor = getContentResolver().query(TargetContentProvider.BASE_URI, null,
                selectTargetsToUpdate(), null, null);
     ...
     * 
     * @return the selection string to select targets needing an update right now
     */
    ...
    private void notifyTargets() {
        ...
        for (Target target : mUpdated) {
            if (target.getStatus() != Status.OK) {
                ...
                TargetNotification.clearErrorNotifications(mNotifMgr, target.getUrl());
            }
        }
    }
}
